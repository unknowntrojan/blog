...
<div class="hidden md:block md:float-right max-w-full md:max-w-[200px] md:ml-[20px]">
<video controls="controls" class="md:float-right">
...
<video controls="controls" class="md:float-right">
	<source src="/images/2023-24-08/fries.webm" type="video/webm"/>
	<source src="/images/2023-24-08/fries.mp4" type="video/mp4"/>
</video>
...
<div class="max-w-full md:max-w-4/12 md:float-right md:w-5/12 w-full overflow-hidden md:ml-4">
...
<lite-youtube class="w-full md:float-right" videoid="krtZGDewYpo" style="background-image: url('https://i.ytimg.com/vi/krtZGDewYpo/hqdefault.jpg');"></lite-youtube>
  *the VOD*
</div>
...
<div class="hidden md:block float-right max-w-full md:max-w-[400px] md:ml-[20px]">
<img src="/images/2023-24-08/souvenir.jpg" class="float-right">
...
<div class="block md:hidden">
<img src="/images/2023-24-08/souvenir.jpg">
